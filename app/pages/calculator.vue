    ...
    <main class="calculator-layout">
      ...
      <section class="calculator-panel">
        ...
        <div
          ...
          class="calculator-status calculator-status--error"
        >
          Failed to load pricing: {{ catalogError }}
        </div>
        ...
        <div
          v-if="submitStatus"
          class="calculator-status calculator-status--submit"
        >
          {{ submitStatus }}
        </div>
...
const steps = reactive<CalculatorStep[]>([
  {
    ...
    subtitle: "First step",
    description:
      "Choose the total number of rooms or zones for the estimate.",
    buttonText: "Confirm room count",
    shortText: "Enter number of rooms.",
    completed: false,
  },
  {
    id: 2,
    ...
    subtitle: "Room list",
    description:
      "Select rooms. The number of selected rooms cannot exceed the number chosen in the previous step.",
    buttonText: "Confirm rooms",
    shortText: "Choose rooms for work.",
    completed: false,
  },
  {
    id: 3,
    ...
    subtitle: "Work for each room",
    description:
      "For each room, choose one or more services.",
    buttonText: "Confirm services",
    shortText: "Choose services by room.",
    completed: false,
  },
  {
    id: 4,
    ...
    description:
      "Enter the area for each selected room.",
    buttonText: "Confirm area",
    shortText: "Add room areas.",
    completed: false,
  },
  {
    id: 5,
    ...
    description:
      "Review all selected data before submitting.",
    buttonText: "Contact us",
    shortText: "Review estimate.",
    completed: false,
  },
  {
    id: 6,
    ...
    description:
      "Fill out the form and we will receive all estimate details.",
    buttonText: "Submit form",
    shortText: "Leave your contacts.",
    completed: false,
  },
]);
...
function completeStep(payload?: Partial<CalculatorData>) {
  if (payload) {
    ...
    if (payload.servicesByRoom) {
      calculatorForm.servicesByRoom = {
        ...payload.servicesByRoom,
      };
    }

    if (payload.areasByRoom) {
      calculatorForm.areasByRoom = {
        ...payload.areasByRoom,
      };
    }
  }
...
function submitForm(payload: ContactForm) {
  ...
  fetch(`${apiUrl}/calculator-leads`, {
    ...
    .then(async (response) => {
      ...
      submitStatus.value = "Request submitted successfully!";
